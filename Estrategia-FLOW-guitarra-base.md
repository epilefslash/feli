...
> **Última actualización:** sesión donde (a) editamos el Video 5 con labels descriptivos, (b) reescribimos
> los guiones 5 y 6 en VERSIÓN HABLADA (Feli habla bien a cámara → es su diferencial), (c) trabajamos los
...
- "Sé las cajas pero no sé conectarlas"
- "Quiero sonar como Page/Slash/Hendrix/Gary Moore pero no sé qué les falta a mis solos"
...
## 2) PUNTO A → PUNTO B (lo que vendés)

- **PUNTO A:** "Sé la pentatónica menor caja 1 pero suena escolar, repito siempre los mismos
  licks, no me muevo del mástil, no suena a los discos que escucho."
- **PUNTO B:** "Improviso solos de rock con sabor, me muevo por las 5 cajas sin pensar, con
  bendings, vibrato y frases inspiradas en Page, Slash, Hendrix, Gary Moore."

**Frase magnética (bio / reels / destacadas):**
> "Te enseño a improvisar solos de rock como Jimmy Page, Slash, Hendrix y Gary Moore —
> dominando la pentatónica menor de verdad."

---

## 3) PROGRAMA DE ALTO VALOR — "Solo con Sabor" (3 meses / 12 semanas)

- **Formato:** grupal online (4–6 alumnos por cohorte), no 1 a 1.
- **Precio:** USD 600–900 (primera cohorte en 600, subir a 900 con 2 testimonios).
- **Tu tiempo:** ~4 hs de vivo por semana para 4–6 personas (mismas horas que antes para 1 alumno).

**Las 4 sesiones semanales (estilo Nico):**
| Día | Sesión | Qué pasa |
|---|---|---|
| Lunes | Teoría / Q&A grupal | Resolver dudas de la semana (el video ya está en la plataforma) |
| Martes | Técnica | Rutina de práctica guiada, todos tocan, vos corregís |
| Jueves | Repertorio | Análisis de un solo icónico por semana |
| Sábado | Improvisación | Cada alumno toca, devolución personalizada (sesión joya) |

**3 Hitos (camino de transformación):**
- **MES 1 — EL MAPA:** las 5 cajas de la pentatónica menor conectadas. Se mueve por todo el mástil.
- **MES 2 — EL SABOR:** bending, vibrato, articulación, espacio. Las frases suenan a música.
- **MES 3 — EL VOCABULARIO:** 20 licks propios inspirados en los grandes.
  *Bonus avanzado al final:* la fusión con la pentatónica mayor (el "secreto SRV").

**Entregables del alumno (prueba de avance):**
- Mes 1: video recorriendo las 5 cajas sin pausa.
- Mes 2: video tocando 5 licks con sabor sobre backing.
- Mes 3: **solo propio grabado de 1 minuto** → este es el testimonio antes/después.

> **Nota clave sobre el delivery:** NO necesitás tener el programa entero armado para venderlo.
> Tenés clara la promesa y el Mes 1. Los meses 2 y 3 y el videocurso se graban SOBRE LA MARCHA con
> la primera cohorte real. Vos sos tu propio caso de éxito: el método es cómo estudiás vos.
> Tu trabajo de los próximos 30 días es GENERAR LEADS, no perfeccionar el delivery.

---

## 4) PRINCIPIOS DE NICO GALLIUSSI (resumen de su material)

**Sobre el programa de alto valor:**
1. El alumno no compra clases, compra un RESULTADO.
2. Cobrar por hora te pone en categoría "servicio barato" (te comparan por precio).
3. Tu experiencia no tiene precio hasta que la convertís en MÉTODO (sistematizar).
4. El programa no necesita ser gigante, sino útil y claro. Si llegás al resultado con MENOS, mejor.
5. Vendés más cuando el alumno ve su antes/después (claridad del Punto A y B > lista de contenidos).
6. No necesitás saber más, necesitás ordenar lo que ya sabés.
7. Un buen programa es un PUENTE, no una playlist: PUNTO A → Hito 1 → Hito 2 → Hito 3 → PUNTO B.

**Sobre por qué NO vender clases individuales:**
- Límite del tiempo (24 hs = techo de ingresos).
- Trampa del precio (te comparan con opciones más baratas).
- Falta de escalabilidad (Patreon/videocursos baratos necesitan volumen masivo).
- Alternativa: vender EXPERIENCIA (acelerar resultados, reducir esfuerzo del alumno).

**Sobre el contenido en redes:**
- Compartí tu FORMA DE PENSAR, no tutoriales sueltos.
- Vendé resultados, no procesos.
- Posicionate como "camino ordenado y simplificado" vs el caos de YouTube.
- Humanizá: invitá a conversación personal (DM → videollamada).

**El embudo simple (vale más si estás por debajo de USD 10.000/mes):**
```
Anuncios → Perfil de Instagram → DMs → Llamada → Venta
```

---

## 5) LOS 3 FORMATOS DE CONTENIDO (marco de Nico) + EL MOLDE DEL FORMATO C

**Los 3 formatos:**
- **Formato A — Demostración pura:** tutorial/lick. Construye AUTORIDAD, NO genera deseo. Atrae curiosos.
- **Formato B — Ataque a creencias:** identifica el error del alumno. Genera DESEO, pero necesita que
  ya confíen en tu autoridad.
- **Formato C — Fusión:** autoridad (tocar bien) + deseo (atacar una creencia) + demostración tangible.
  **EL QUE MÁS CONVIERTE.** El instrumento es el FISCAL del argumento, no decoración.

**El molde del Formato C (5 movimientos):**
```
1. CREENCIA / DOLOR  →  Decís o mostrás lo que la mayoría cree
2. CONTRA-EJEMPLO     →  Tocás como lo hace el promedio (suena mediocre, A PROPÓSITO)
3. REVELACIÓN         →  Explicás (texto o voz) por qué eso está mal
4. PRUEBA EN VIVO     →  Tocás la versión correcta (suena tremendo)
                       →  El CONTRASTE es la prueba irrefutable
5. CTA                →  "Si querés saber cómo, comentá SOLO"
```

**Distribución de tiempos (reel ~35-40 seg):**
| Tramo | Duración | Función |
|---|---|---|
| Hook (texto + cara) | 3 seg | Pregunta inicial |
| MAL ejemplo | **5–7 seg** | Setup |
| Revelación (texto/voz) | 6 seg | El argumento |
| BIEN ejemplo | **12–16 seg** | Knockout |
| Cierre + CTA | 5 seg | Te muestro cómo / comentá SOLO |

> **Proporción MAL:BIEN = 1:2 mínimo.** El "bien" siempre dura más que el "mal".
> El "mal" debe sonar a "estudiante esforzado", no a parodia: rápido y parejo, sin resolver,
> zona aguda angosta, CERO bending/vibrato/espacio, cara concentrada en el mástil.

**Regla 70/30 para la serie de reels:**
- 70% → tocás VOS (mal a propósito + bien tuyo). Formato C puro. CONVIERTE.
- 30% → analizás solos icónicos ajenos con texto. Sirven para ALCANCE.

---

## 6) LISTA DE CREENCIAS LIMITANTES (mina de oro — 1 video Formato C cada una)

1. *"Necesito aprender más escalas."* → Usá bien la pentatónica que ya sabés. ✅ Video 4.
2. *"Tengo que tocar rápido para sonar bien."* → Una nota con vibrato vale por 20 atropelladas.
3. *"La pentatónica es de principiantes."* → Angus, Page, Slash, Hendrix, Gary Moore la usaron toda su vida. 🎬 Video 5.
4. *"Necesito un buen equipo para sonar como ellos."* → El sonido sale de los dedos. 🎬 Video 6.
5. *"Tengo que estudiar 4 horas por día."* → 20 min bien diseñados rinden más que 4 hs de videos.
6. *"Mis solos suenan a escala porque me faltan licks."* → Te falta espacio, vibrato y bending.
7. *"Si toco lento, parezco principiante."* → Gilmour y Gary Moore tocan lento. Lento = pro.
8. *"No tengo oído."* → Tenés oído. Hay que entrenarlo, no nacer con él.
9. *"Mirar tutoriales me va a hacer mejor."* → Acumular qués sin un cómo te frustra más.
...
|---|---|---|
| 0:00–0:03 | "¿Crees que la pentatónica menor es de principiantes?" | Plano cerrado, mirás cámara, sin tocar |
...
**El "bien" (15 seg):** penta menor de Mi pura estilo Page/Slash: bending Re→Mi (traste 15) sostenido
con vibrato amplio, frase descendente por cajas 1 y 2, silencio 1 seg en el medio, cierre con
doble parada tipo Hendrix o bending largo con vibrato. TUYO, improvisado.

**Referencias del "MAL" (mirar antes de filmar para calibrar la cabeza):**
- "Yngwie Malmsteen neoclassical exercise" (YouTube) — escalas a 220 BPM sin contexto
- Tutoriales "locrian lick" / "lydian dominant lick" — técnica sin alma
- "Frank Gambale sweep picking exercise" — sweeps sin canción
- (NO mencionar a Yngwie en el reel. Mantenelo abstracto: "técnica sin sabor no enamora".)

**Referencias del "BIEN" (escuchar antes de filmar):**
- Gary Moore – "Still Got the Blues" (solo)
- Slash – "Sweet Child O' Mine" (intro)
- Jimmy Page – "Whole Lotta Love" (solo del medio)
- David Gilmour – "Comfortably Numb" (segundo solo)
- Jimi Hendrix – "Voodoo Child (Slight Return)"

**Copy del post:**
> 🎸 "La pentatónica menor es para principiantes."
>
> Esa frase me la dijeron 100 veces. Y es la responsable de que cientos de guitarristas tiren a la
> basura la escala más importante del rock.
>
...
>
> El bending, el vibrato, el espacio, la dinámica, la conexión entre cajas… eso separa a Slash de
> cualquiera que estudia escalas en YouTube.
>
> Si estás dejando de lado la pentatónica menor porque te parece básica, estás cometiendo el mismo
> error que cometí yo durante años. Volvé a ella. Pero esta vez, en serio.
>
...
- Gatitos meme en el "mal" (cara de sospecha de que algo suena raro) → humor desarma, sube shareability.
- Efecto "Heavenly Music" cuando decís/aparece "pentatónica" → premia el oído, refuerza el antes/después.
- Build up drums + riser bajito (20-30%) en la pregunta inicial → tensión. Corta cuando entra la acción.
- Medio segundo de SILENCIO total entre el "mal" y el "bien" → el alivio hace que el "bien" pegue doble.
- Zooms: cara cuando hacés un punto, manos cuando tocás algo clave. Máx 3-4 por reel.
- Cuidá que meme + efecto NO tapen el audio de la guitarra (el contraste sonoro es el argumento).
- Subtítulo en la frase hablada (70% mira sin sonido al principio).
- Niveles: voz/guitarra 100% > riser/efectos 20-30% > backing 15%.
...
## 10) PANEL DE REFERENTES (a qué creencia sirve cada uno)

| Guitarrista | Por qué sirve | Mejor para creencia |
|---|---|---|
| **Angus Young** (AC/DC) | SG + Marshall, CERO pedales, penta menor pura | "No es el equipo" (LA joya) |
| **Jimmy Page** | Telecaster + ampli simple, penta menor | "No es el equipo" / "Penta básica" |
| **Slash** | Penta menor + nota de paso, intro Sweet Child = 6 notas | "Tocar rápido" / "Penta básica" |
| **Hendrix** | Penta menor + doble paradas, truco de la mayor | "Penta básica" / "Más escalas" |
| **Gary Moore** | Una escala, llorando la guitarra, bending/vibrato | "Tocar rápido" / "Penta básica" |
| **Joe Perry** (Aerosmith) | Penta menor sucia, groove | "Más licks" / "Tocar rápido" |
...
| **Mark Knopfler** | Sin púa, sin distorsión, imposible de copiar | "No es el equipo" (cierre brutal) |

---

## 11) EMBUDO + BIO + DESTACADAS

**Embudo:**
```
Contenido orgánico IG (reels Formato C) → Perfil magnético (bio + reel fijado + destacadas)
→ DM (comenta SOLO / CAJAS) → Llamada de descubrimiento (15-20 min, POR VOZ) → Venta (USD 600-900)
```
...
## 12) COPY MAESTRO (el de Andy Kligman adaptado a tu voz) — para reels de dolor/historia

> 👉 Veo muchos guitarristas que quieren mejorar sus solos de rock, y se la pasan todo el día
> consumiendo videos de Instagram y YouTube. Tutorial tras tutorial, lick tras lick, pensando que si
> acumulan más material van a mejorar. El problema es que no funciona. Y a veces es contraproducente.
>
> 🎯 El obstáculo no es la falta de información, es el exceso. Acumulamos "qués" cuando lo que importa
> es el "cómo". Si no entendés cómo estudiar la pentatónica menor, podés tener 200 licks guardados y
> seguir tocando igual que hace dos años.
>
> A mí me pasó. Me pasaba horas mirando videos de Page, Slash, Hendrix, Gary Moore, copiando frases
> sueltas. Y me frustraba cada vez más. Sabía un montón, pero al improvisar seguía sonando a escala,
> no a música.
>
> 📕 Lo que me cambió fue tener un guía que me ordenó la práctica con ejercicios claros, encadenados
> con sentido. No necesitaba más información: necesitaba menos, pero ordenada.
>
> 🤓 Lo que me salvó fue aprender a aprender. Un paso por vez: primero las 5 cajas, después el sabor
> (bending, vibrato, espacio), después el vocabulario de los grandes.
>
> Si te sentís estancado, buscá un guía. Alguien que te enseñe a practicar, no que te tire data para
> que te arregles solo.
>
> Mandame un DM 📩 con la palabra **SOLO** y te cuento cómo trabajo.

---

## 13) GLOSARIO DE EDICIÓN (CapCut) — lo que aprendimos

| Querés | Buscá en CapCut |
|---|---|
| Batería que sube tensión | "build up" / "tension drums" / "suspense drums" |
| El "wooo" que sube en tono | **"riser"** / "tension riser" |
| Golpe de impacto grave | "braam" / "boom" |
| Transición rápida | "whoosh" |
| Premio celestial | "Heavenly Music" sound effect |

**Fórmula de tensión:** [build up drums subiendo] + [riser subiendo] → 💥 corte/revelación.
El riser termina justo cuando empieza la acción.

**Niveles de volumen (de más fuerte a más bajo):**
1. Voz / guitarra → 100%
2. Riser / build up / efectos → 20-30%
3. Backing de fondo → 15%

**Arco emocional del reel Formato C:**
😬 Tensión (mal + gatito) → 🤔 Revelación (texto) → 😇 Alivio (bien + Heavenly + tu solo) → 🎯 Acción (CTA).

---

## 14) PRÓXIMOS PASOS

- [ ] Filmar Video 5 y Video 6 (guiones en secciones 7 y 8) — mismo día (ver orden de filmación abajo).
- [ ] Armar Video 7 (creencia "20 min vs 4 hs" o "tocar lento = pro").
...
**Orden de filmación sugerido para #5 + #6 el mismo día:**
1. Calentás 10 min (repasás los licks del "bien" de ambos).
2. Filmás los "mal" de los 2 seguidos (#5 modos sobre Mm, #6 lick básico con todo el gear).
3. Cambiás a setup limpio.
4. Filmás los "bien" de los 2 seguidos (penta menor con sabor, sonido pelado).
...
> (A) qué te va a enseñar Nico en la mentoría (el arco de ~3 meses), y (B) una simulación GUIONADA de
> una clase grupal tuya real, mes 2, con diálogo. Es ficción realista: sirve para que Feli "vea" el
> destino y deje de tenerle miedo a la niebla.

---

### PARTE A — Qué te va a enseñar Nico (arco de la mentoría, ~3 meses)

**Mes 1 con Nico — POSICIONAMIENTO Y OFERTA (arreglás el "qué vendés").**
- Definir con bisturí el avatar (ya lo tenés: guitarrista intermedio autodidacta frustrado).
- Convertir tu experiencia en MÉTODO: nombrar los hitos (Mapa → Sabor → Vocabulario). Ya empezado.
- Construir la oferta de alto valor: qué incluye, precio, garantía, por qué vale 10x lo que cobrás.
- Escribir la promesa (Punto A → Punto B) que va en bio, reels y llamada de venta.
- *Lo que vas a sentir:* "ah, no tengo que saber más guitarra, tengo que ORDENAR lo que sé". Alivio.

**Mes 2 con Nico — ATRACCIÓN Y CONTENIDO (arreglás el "cómo llegan").**
- Sistema de contenido constante (tus reels Formato C ya son esto — llegás adelantado).
- Guiones que atacan creencias + CTA con keyword (ya lo venís haciendo).
- Cómo leer las métricas que importan (comentarios/guardados, no likes).
- Empezar a nutrir al 97% (regla Sergio): stories, copy de dolor, responder DMs.
- *Lo que vas a sentir:* "esto ya lo estaba haciendo bien". Confianza.

**Mes 3 con Nico — CONVERSIÓN Y DELIVERY (arreglás el "cómo cierro y cómo entrego").**
- La llamada de descubrimiento paso a paso (diagnóstico → objetivo → oferta → cierre). Practicar por voz.
- Manejo de objeciones ("es caro", "no tengo tiempo", "¿y si no me sale?").
- Estructurar el delivery: las 4 sesiones semanales, cómo dar la clase grupal (sección 16).
- Cómo grabar las clases para armar el videocurso sobre la marcha.
- *Lo que vas a sentir:* "puedo dar esto". El miedo del delivery se disuelve porque ya tenés el mapa.

> **Traducción:** Nico NO te va a enseñar a tocar mejor (ya tocás). Te va a enseñar a EMPAQUETAR,
> ATRAER, VENDER y ENTREGAR lo que ya sabés. El técnico nunca fue el problema (lección del caso Sergio).

---

### PARTE B — SIMULACIÓN GUIONADA: una clase grupal tuya, Mes 2, Sábado (sesión de improvisación)

> Es un sábado de octubre. Ya lanzaste. Tenés 4 alumnos en tu primera cohorte "Solo con Sabor":
> **Diego** (35, ingeniero, toca hace 4 años, vive en caja 1), **Marce** (42, médico, muy cabeza, poca
> mano), **Nacho** (28, el más avanzado, le falta sabor), **Lucía** (31, la que menos toca pero la más
> aplicada). Son las 11 de la mañana. Abrís Zoom. Ya no te tiembla el pulso — es tu cuarta clase.

**[11:00 — Entrada]**
> **Vos:** "¡Buenas! ¿Cómo andan? Diego, veo que ya estás con la viola en la mano, me gusta. Marce,
> ¿pudiste practicar esta semana o te comió el hospital?"
> **Marce:** "Poco, Feli, una guardia jodida. Pero algo hice."
> **Vos:** "Tranqui, con lo que hiciste alcanza. Hoy es sábado de improvisación, así que hoy tocan
> USTEDES. Yo casi no voy a tocar. Arranquemos."

*(Fijate: ya rompiste el hielo, tomaste el pulso, y encuadraste la clase en 90 segundos.)*
...
**[11:05 — Nacho toca. Corrección en vivo.]**
> *(Nacho solea sobre el backing. Toca lindo pero atropellado, lleno de notas.)*
> **Vos:** "Pará, pará, buenísimo el vocabulario. Pero contame: ¿cuántos segundos de silencio dejaste
> en todo eso?"
> **Nacho:** "…cero."
> **Vos:** "Cero. Y sos el que mejor mano tiene de los cuatro. Imaginate lo que pasa cuando le sumes
> aire. Volvé a entrar, pero esta vez tocá TRES notas, y esperá. Contá hasta dos en tu cabeza antes
> de la próxima frase."
> *(Nacho lo hace. Suena 10 veces mejor. El grupo lo escucha.)*
> **Vos:** "¿Escucharon eso? Mismas notas que antes. Pero ahora dicen algo. Eso es todo el método,
> muchachos. Anótenlo."

*(Este momento es ORO: Nacho aprendió, pero Diego/Marce/Lucía TAMBIÉN aprendieron mirando. Eso es la
magia del grupal que no tenés en el 1 a 1.)*

**[11:12 — Diego toca. El caso difícil.]**
> *(Diego, el de caja 1, toca inseguro, se queda en 4 notas.)*
> **Vos:** "Diego, ¿sabés qué? Me encanta que te quedes en pocas notas, pero te noto encerrado en la
> caja 1. Probemos algo en vivo: cuando llegues arriba de todo, en vez de volver, estirá un traste más
> con un bending. Uno solo. Te espero."
> *(Diego lo intenta, le sale a medias.)*
> **Vos:** "¡Ahí está! No salió perfecto y no importa. Salió VALIENTE. Esa nota que estiraste es la
> puerta a la caja 2. La semana que viene la abrimos entera. Aplausos para Diego que se animó a salir
> de la casita." *(el grupo reacciona, Diego se ríe aliviado)*

*(Fijate el manejo: al que menos sabe lo hacés sentir campeón por INTENTAR, no por lograr. Eso lo
retiene. Un alumno que se siente tonto se va; uno que se siente valiente, se queda y te renueva.)*

**[11:20 — Marce y Lucía tocan. Devolución corta a cada uno.]**
> *(Rondás a los dos. A Marce, el cabeza: "menos analizar, más sentir — cerrá los ojos la próxima".
> A Lucía, la aplicada: "tu vibrato mejoró un montón, se nota que practicaste, ahora sumale un bending
> largo al final de la frase".)*

**[11:35 — Aplicación grupal / cierre de la joya]**
> **Vos:** "Última vuelta. Pongo el backing y tocan los cuatro seguidos, sin parar, encadenados. El
> que termina le pasa a al siguiente con una nota larga. Como una banda. Vamos."
> *(Los cuatro tocan encadenados. Se ríen, se equivocan, fluye. Vos casi no hablás.)*

**[11:50 — Tarea y cierre]**
> **Vos:** "Lo de hoy fue ESPACIO. Tarea de la semana: grábense 30 segundos improvisando sobre el
> backing que les dejo, con la regla de las tres notas y el silencio. Me lo mandan al grupo. La semana
> que viene: abrimos la caja 2 y la conectamos con la 1. Ahí empieza a moverse todo el mástil.
> Gracias muchachos, sábado tremendo. Abrazo."
> *(Cortás Zoom. La clase quedó grabada — ese archivo es un pedazo de tu futuro videocurso.)*

---

### Qué demuestra esta simulación (lecciones para vos, Feli)
1. **Tocaste el 10% del tiempo.** El resto tocaron ellos. Una buena clase grupal NO es vos haciendo un show — es vos dirigiendo. Eso ya lo sabés hacer.
2. **Cada corrección enseñó a los cuatro.** Corregiste a Nacho y Diego aprendió. Eso multiplica tu hora.
3. **El manejo emocional > lo técnico.** A Nacho lo desafiaste, a Diego lo hiciste sentir valiente, a Marce lo aflojaste, a Lucía la reforzaste. Retener alumnos es 80% cómo los hacés sentir. Y vos ya tenés calle para eso.
4. **Nada de esto requería un videocurso previo.** Requería: Zoom, tu guitarra, un backing track, y saber enseñar. Todo lo que ya tenés.
5. **La clase se grabó sola.** Cuatro clases grabadas = el esqueleto de tu producto para la cohorte 2.

> **El punto de toda la simulación:** el "después" no es un salto a lo desconocido. Es tu clase de
> siempre, con más gente, por Zoom, con un método ordenado atrás. El 90% ya lo sabés. El 10% que falta,
> te lo da Nico y la práctica. No hay abismo. Hay un escaloncito.
...
## 25) GUION VIDEO #11 — "TU HISTORIA" (60 seg, humaniza) — VERSIÓN FINAL
...
> **Los 6 datos reales que dio Feli (base de esta versión):** empezó a los 11 años · aprendió de todas
> las formas posibles (TAB de internet, videos, profesor particular, y después la UNR de Rosario —
> no se recibió, pero aprendió muchísimo) · su Punto A fue años tocando siempre las mismas frases,
> A PESAR de todo ese estudio formal · el quiebre fue un profesor puntual que le enseñó a **conectar
...
> "Lo que cambió todo fue un profesor que en vez de enseñarme una caja más, me enseñó a conectar
> el mástil entero. Ahí entendí que el problema nunca fueron las notas que me faltaban —
> era que tenía cinco cajas separadas en la cabeza, en vez de un solo mapa."

**[0:38–0:50] EL PUNTO B — quién soy ahora**
...
- El dato de la facultad (UNR) es un activo, no un detalle menor: "estudié formalmente y AUN ASÍ me
  pasaba esto" es un argumento de autoridad mucho más fuerte que "no estudié nada". No lo minimices
  ni te disculpes por no haberte recibido — no hace falta explicarlo, simplemente contalo así.
...
>
> Lo que me cambió la cabeza fue un profesor que me enseñó a conectar el mástil entero, en vez de
> memorizar cajas sueltas. Ahí empecé a improvisar de verdad, con libertad.
>
> Por eso armé mi método empezando siempre por ahí: el mapa completo. Quiero ahorrarte los años
> que a mí me llevó entenderlo.
>
...
## 27) "CÓMO ES UNA CLASE" — DADO DE BAJA COMO VIDEO PÚBLICO, PASA A SER ENSAYO PRIVADO

> **Decisión de Feli (correcta):** este contenido — el desglose completo del delivery, los 3 hitos,
> las 4 sesiones semanales — es exactamente lo que Nico enseña a trabajar EN LA LLAMADA de
> descubrimiento, mano a mano con el potencial cliente, no en un reel público. Publicarlo le regala
> al visitante la información que debería generar la conversación privada: le saca a la llamada su
> único motivo de existir.
>
> **Qué hacer en cambio:** grabate igual, sin subir — es un ejercicio excelente para practicar cómo
> se lo explicás en voz a alguien real antes de la primera llamada de verdad. El guion de las
> secciones 20 (estructura de las 4 sesiones) y 19 (la oferta) ya tienen todo el contenido que
> necesitás decir ahí; no hace falta un guion aparte.
>
> **Reemplazo en el stock público:** en su lugar van los 2 guiones VENDEDORES que ya estaban
> escritos (secciones 21 y 23) — "Como que desaparece" y "Dejá de mirar tutoriales". Son contenido
> de conversión pura y cumplen mejor la función que se buscaba (mover al 3% listo para comprar hacia
> el DM), sin regalar en público lo que la llamada necesita vender. Ver el PDF de guiones
> (`Guiones-Historia-Fijado-Vendedores.pdf`) para la versión con línea de tiempo de ambos.

**Orden de filmación actualizado para los 3 videos de esta ronda:** HISTORIA primero (más ensayo,
más carga emocional) → FIJADO segundo (el más simple: solo tocar bien, sin hablar) → uno de los dos
VENDEDORES al final ("Dejá de mirar tutoriales" si preferís tener guitarra sonando y un backing de
fondo; "Como que desaparece" si preferís un video a cámara, sin tocar, todo en la mirada).

> ⚠️ Recordá la regla de secuencia de la sección 9: los vendedores se publican recién cuando ya
> haya autoridad construida (después de varios Formato C) — no los subas como primer contenido,
